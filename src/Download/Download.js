...
class Download extends React.Component {
  constructor(props) {
    ...
    this.handleInputChangeVideoLink =
      this.handleInputChangeVideoLink.bind(this);
  ...
  downloadVideo = () => {
    ...
    axios
      .get("http://localhost:5000/downloadVideo", {
        params: {
          videoLink: this.state.videoLink,
          qualityLabel: optionsVideo[this.state.selectedIndex],
        },
        responseType: "blob",
      })
      .then((response) => {
  ...
  downloadAudio = () => {
    axios
      .get("http://localhost:5000/downloadAudio", {
          ...
          <div className="downloader">
            <form className="youtubeVideo">
              <Input
                ...
                onChange={this.handleInputChangeVideoLink}
                required={true}
                color="primary"
                fullWidth={true}
              />
                ...
                <Grid item xs={4}>
                  ...
                  >
                    <Button onClick={this.handleToggle}>
                      {optionsVideo[this.state.selectedIndex]}
                    </Button>
                    <Button
                      color="primary"
                      size="small"
